...
export default function ProfileSetupScreen() {
  const [selectedCategories, setSelectedCategories] = useState<string[]>(['Beauty', 'Lifestyle', 'Entertainment']);
  const [about, setAbout] = useState('');
  const [languages, setLanguages] = useState<string[]>(['Hindi', 'English', 'Telugu']);
  ...
  const categories = [
    'Beauty', 'Lifestyle', 'Entertainment', 'Gaming', 'Travel', 'Food', 
  ...
  const handleNextStep = async () => {
    ...
    console.log('Saving profile data:', { selectedCategories, about, languages, platforms });
    
    // Simulate API call
    setTimeout(() => {
      setLoading(false);
      // Navigate to next step
      window.location.href = '/profile-setup-step2';
    }, 1000);
  };
  ...
  return (
    <div className="min-h-screen bg-white font-poppins-regular flex flex-col">
      ...
      <div className="flex flex-col lg:flex-row flex-1 w-full bg-white">
        ...
        <div className="w-full lg:w-1/2 px-3 sm:px-6 lg:pl-3 lg:pr-12 xl:pl-6 xl:pr-16 py-12 sm:py-16 lg:py-24 flex flex-col justify-center items-center lg:items-center">
          <div className="max-w-sm lg:max-w-md xl:max-w-lg w-full space-y-4 sm:space-y-6">
            ...
            {/* Introductory Text */}
            <p className="text-xs sm:text-sm text-textGray font-poppins-regular mb-4 sm:mb-6">
            ...
            <div className="space-y-2">
              ...
              <div className="border border-gray-200 rounded-lg p-2 flex items-center">
                ...
                >
                  <span className="text-sm text-textGray font-poppins-regular">
                    {platforms.length === 0 ? 'Select Platforms' : `${platforms.length} selected`}
                  </span>
                  <svg 
      ...
      {/* This modal is now handled inline */}
    </div>
  );
}
